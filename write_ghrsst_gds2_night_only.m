...
% Modification CCR2281: Replaced METOPA with METOPB; replaced GAC with FRAC
%    for METOPB.
...
ncwriteatt(nc_filename_wpath,'analysed_sst','source','OSPO-ACSPO_VIIRS, OSPO-ACSPO_METOPB_FRAC, OSPO-GOES16_SST_L3,OSPO-GOES15_SST_L3, OSPO-METEOSAT11_SST_L3, OSPO-HIMA8_SST_L3');
ncwriteatt(nc_filename_wpath,'analysed_sst','comment','nighttime analysed SST for each ocean grid point');
...
ncwriteatt(nc_filename_wpath,'/','title','Analysed blended sea surface temperature over the global ocean using night only input data');
...
ncwriteatt(nc_filename_wpath,'/','comment','The Geo-Polar Blended Sea Surface Temperature (SST) Analysis combines multi-satellite retrievals of sea surface temperature into a single analysis of SST. This analysis includes only nighttime data.');
...
ncwriteatt(nc_filename_wpath,'/','source','OSPO-ACSPO_VIIRS, OSPO-ACSPO_METOPB_FRAC, OSPO-GOES16_SST_L3, OSPO-GOES15_SST_L3, OSPO-METEOSAT11_SST_L3, OSPO-HIMA8_SST_L3');
