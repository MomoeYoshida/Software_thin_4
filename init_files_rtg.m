function [sst, sst_variability,ok]= init_files_rtg(year, day, varargin);
...
if(hires)
	...
	earlier_sst=rebin(earlier_sst,5/6,'bilinear');
        ...
        [start_sst]=get_rtg_grib(year,day);
        start_sst=rebin(start_sst,5,'bilinear');

        [earlier_sst]=get_rtg_grib(year,day-10);
        earlier_sst=rebin(earlier_sst,5,'bilinear');
end
