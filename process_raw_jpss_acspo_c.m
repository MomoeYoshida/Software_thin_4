function [ok]= process_raw_jpss_acspo_c(stream, year, day, ref_sst, sst_variability, sst_check);
...
for filetype=start_day_night:end_day_night    %  Just the day & night cloudflag=0 cases...
   ...
   switch filetype
      case 0
         ...
         cmask=0;
         datalabel_day = [jpss_name '_day_c0_'];
...
% Load up appropriate biases from yesterday's biases file.
      ...
      case 1
         ...
         cmask=0;
         datalabel_night= [jpss_name '_night_c0_'];
...
message2(['*** Processing ' jpss_name ': ' messagelabel])
...
[run_ok day_there sst_day stdvals_day gridcount_day dumparray_day ...
 ...
 total_bad_night_stdev] = process_raw_avhrr_acspo_mex(jpss_name, year, day,...
                                                      ref_sst,...
                                                      sst_variability,...
                                                      sst_check, bias_day,...
